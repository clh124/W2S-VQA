...
def load_motion_feature(image_id):
    motion_root = '/home/bml/storage/mnt/v-f028498a5029402d/org/3dshuziren/3dshuziren/clh_data/train_30w/slowfast_feature/'
    motion_feat_list = []
    ...
    for img_index in range(min(int(max_motion_idx)+1, 10)):  # 限制 img_index 最大值为 10
